<nav x-data="{ open: false, sidebarOpen: false }" class="bg-white border-b border-gray-100 relative z-40">
    ...
    <div x-show="sidebarOpen" @click.away="sidebarOpen = false"
        ...
        <nav class="px-4 py-4 space-y-2">
            <a href="{{ route('bookings.create') }}" class="bg-gradient-to-r from-pink-100 via-pink-200 to-rose-100">
                ➕ Create Booking
            </a>
            <a href="{{ route('bookings.index') }}" class="bg-gradient-to-r from-pink-100 via-pink-200 to-rose-100">
                📋 View Bookings
            </a>
            <a href="{{ route('users.index') }}" class="bg-gradient-to-r from-pink-100 via-pink-200 to-rose-100">
                👤 User Management
            </a>
        </nav>
    </div>
